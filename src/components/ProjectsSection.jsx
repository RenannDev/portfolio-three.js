...
const ProjectsSection = () => {
  ...
  const horizontalRef = useRef(null);
   ...
   useEffect(() => {
    ...
    // Animação para o título e a linha
    gsap.fromTo(
      titleRef.current,
      { y: 100, opacity: 0 },
      {
    ...
    // Animação para a linha
     gsap.fromTo(
      ...
      { width: "0%", opacity: 0 },
      {
        width: "100%", // ✅ Valor final definido!
        opacity: 1,
        duration: 1.5,
        ease: "power3.inOut",
        delay: 0.3,
    ...
    // criar o efeito de scroll horizontal
    const horizontalScroll = gsap.to(".panel", {
        ...
        // limpar o ScrollTrigger na desmontagem do componente
